...
The game has no in-game language setting — every label is Portuguese only — so a single Portuguese (Portugal) listing is provided below; add it under pt-pt in Partner Center. Like this developer's other games (Queens, Zip Path, Patches), the app name itself is **not** localized: it stays "Animal Labyrinth".

## Images

Rendered in-engine from the game's own drawing code, icon and fonts — no external image editor involved.
...
## Portuguese (Portugal) (pt-pt) — Animal Labyrinth
...
Joga com o rato: escolhe o animal e a dificuldade, coloca as peças, e vê se o teu animal chega a bom porto.
